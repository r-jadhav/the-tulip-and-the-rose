                ...
                <div className="row">
                    <div className="col-lg-6">
                        ...
                        <div className="heading-section text-center">
                            ...
                            <div className="title text-1">Espresso</div>
                        </div>
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="heading-section text-center">
                            <div className="sub-title">Best Drinks</div>
                            <div className="title text-1">Coffee & Tea</div>
                        </div>
            ...
            <div className="tf-container">
                <div className="row">
                    <div className="col-lg-6">
                        ...
                        <div className="heading-section text-center">
                            <div className="sub-title">Best Drinks</div>
                            <div className="title text-1">Specialty Drinks</div>
                        </div>
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="heading-section text-center">
                            <div className="sub-title">Best Drinks</div>
                            <div className="title text-1">Cold Drinks</div>
                        </div>
